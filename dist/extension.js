...
<section class="stig" data-idx="${e}">
  ...
  <!-- stat cards -->
  <div class="cards">
    <div class="card card-total"><div class="card-n">${i.total}</div><div class="card-l">Total</div></div>
    <div class="card card-open"><div class="card-n">${i.open}</div><div class="card-l">Open</div></div>
    <div class="card card-naf"><div class="card-n">${i.not_a_finding}</div><div class="card-l">Not a Finding</div></div>
    <div class="card card-nr"><div class="card-n">${i.not_reviewed}</div><div class="card-l">Not Reviewed</div></div>
    <div class="card card-na"><div class="card-n">${i.not_applicable}</div><div class="card-l">Not Applicable</div></div>
  </div>

  <!-- severity bar -->
  <div class="sev-bar">
    <div class="sev-seg sev-high" style="width:${l(i.high)}%"><span>CAT I \xB7 ${i.high}</span></div>
    <div class="sev-seg sev-med"  style="width:${l(i.medium)}%"><span>CAT II \xB7 ${i.medium}</span></div>
    <div class="sev-seg sev-low"  style="width:${l(i.low)}%"><span>CAT III \xB7 ${i.low}</span></div>
  </div>
